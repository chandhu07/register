...
window.addEventListener("load",function()
{
    ...
    var res9 =params.get('semi');
    resh = parseFloat(res9);
    ...
    if(semnum==1 ){
        ...
        var sem9th = (resa + resb + resc + resd + rese + resf + resg + resh + resi)/9
        document.getElementById("result").innerHTML="YOUR AVERAGE RESULT : "+sem9th.toFixed(2);
        document.getElementById("Percentage").innerHTML="YOUR EQUIVALENT PERCENTAGE : "+((sem9th - 0.75) * 10).toFixed(2);
    }
    else{
...
/*window.addEventListener('load', () => {
    ...
    document.getElementById('result-usn').innerHTML = usn;
